    ...
    <div class="lg:container w-full">
        <div class=" flex items-center justify-between relative px-6  sm:px-9 lg:px-16 py-3 sm:py-7 lg:py-3 text-base sm:text-xl lg:text-base ">
            ...
            <ul class="items-start top-0 right-0 translate-x-[100%] transition-all ease-linear duration-[400ms] absolute justify-start flex flex-col w-10/12 h-screen lg:static lg:translate-x-0 lg:flex-row lg:h-max lg:w-max bg-blue-800 lg:bg-transparent">
                ...
                ' text-slate-200 lg:text-slate-900    '  }}
                ...
                after:absolute after:bg-slate-200 lg:after:bg-blue-600 after:h-[2px] after:w-0 after:left-0 after:bottom-[-7px] lg:after:bottom-[-4px] after:transition-all after:duration-300 hover:after:w-[50%] after:content-['']  my-[1.1rem] sm:my-[2rem] lg:my-0 mx-8 sm:mx-12  lg:mx-0    lg:ml-11    lg:hover:text-blue-600 cursor-pointer  relative px-0 liScrol group">
                    ...
                    <div class="dropDown block absolute z-30 left-0 top-[100%] bg-slate-50 rounded-md mt-5 w-56">
                        <ul class="hidden text-sm font-cabin text-slate-600 navbar-menu-list">
                            <a class="cursor-pointer py-3 border-b border-b-slate-300 px-7 hover:text-blue-600 block" href="/profileSMPN16#tentangSekolah">Tentang Sekolah</a>
                            <a class="cursor-pointer py-3 border-b border-b-slate-300 px-7 hover:text-blue-600 block" href="/profileSMPN16#visiDanMisi">Visi Dan Misi</a>
                            <a class="cursor-pointer py-3 border-b border-b-slate-300 px-7 hover:text-blue-600 block" href="/profileSMPN16#tataTertib">Tata Tertib</a>
                            <a class="cursor-pointer py-3 px-7 hover:text-blue-600 block" href="/profileSMPN16#news">News </a>
                ...
                after:absolute after:bg-slate-200 lg:after:bg-blue-600 after:h-[2px] after:w-0 after:left-0 after:bottom-[-7px] lg:after:bottom-[-4px] after:transition-all after:duration-300 hover:after:w-[50%] after:content-['']  my-[1.1rem] sm:my-[2rem] lg:my-0 mx-8 sm:mx-12  lg:mx-0    lg:ml-11    lg:hover:text-blue-600 cursor-pointer  relative px-0 liScrol group ">
                    ...
                    <div class="dropDown block absolute z-30 left-0 top-[100%] bg-slate-50 rounded-md mt-5 w-56">
                        <ul class="hidden text-sm font-cabin text-slate-600 navbar-menu-list">
                            ...
                            <a class="cursor-pointer py-3 border-b border-b-slate-300 px-7 hover:text-blue-600 block" href="/kesiswaan#galeri">Galeri</a>
                            <a class="cursor-pointer py-3 border-b border-b-slate-300 px-7 hover:text-blue-600 block" href="/kesiswaan#prestasi">Prestasi</a>
                ...
                after:absolute after:bg-slate-200 lg:after:bg-blue-600 after:h-[2px] after:w-0 after:left-0 after:bottom-[-7px] lg:after:bottom-[-4px] after:transition-all after:duration-300 hover:after:w-[50%] after:content-['']  my-[1.1rem] sm:my-[2rem] lg:my-0 mx-8 sm:mx-12  lg:mx-0    lg:ml-11    lg:hover:text-blue-600 cursor-pointer  relative px-0 liScrol group ">
                    ...
                    <div class=" dropDown block absolute z-30 left-0 top-[100%] bg-slate-50 rounded-md mt-5 w-56">
                        <ul class=" hidden text-sm font-cabin text-slate-600 navbar-menu-list ">
                            <a class="cursor-pointer py-3 border-b border-b-slate-300 px-7 hover:text-blue-600 block" href="/kepegawaian#guru">Guru</a>
                            <a class="cursor-pointer py-3 px-7 hover:text-blue-600 block" href="/kepegawaian#waliKelas">Wali kelas</a>
                            {{-- <li class="py-3 border-b border-b-slate-900 px-7"><a href="#">tiket photo</a></li> --}}
                        </ul>
                    </div>
                </li>
            ...
            {{-- toogle button --}}
            <div class="lg:hidden block cursor-pointer text-[1.55rem] sm:text-[2.2rem] text-slate-900 hamburgerMenu" id="menuToogle">
