        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col relative">
            <main class="w-full flex-grow p-6 mb-14">
                ...
                <div class="mt-4">
                    ...
                    <h1 class="text-xl text-slate-700 font-semibold font-lexend">Tambah Guru</h1>
                    @include('dashboard.admin.tambahGuru.createNewGuru')
                    @include('dashboard.admin.tambahGuru.guruAll')
                </div>
            </main>
        </div>
    </div>
