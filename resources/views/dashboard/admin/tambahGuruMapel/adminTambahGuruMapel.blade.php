        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col relative">
            <main class="w-full flex-grow p-6 mb-14">
                <div class="mt-4">
                    ...
                    <h1 class="text-xl text-slate-700 font-semibold font-lexend">Guru &  Mata Pelajaran</h1>
                    @include('dashboard.admin.tambahGuruMapel.createNewGuruMapel')
                    @include('dashboard.admin.tambahGuruMapel.mapelAll')
                </div>
            </main>
        </div>
    </div>
