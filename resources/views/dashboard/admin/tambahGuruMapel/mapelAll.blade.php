<div class="grid grid-cols-12 gap-6 mt-14">
    <div class="col-span-12 sm:col-span-12 bg-gray-50 shadowMe px-4 border-t-2 border-t-blue-500 pb-10 h-max">
        ...
        {{-- header --}}
        <h1 class="mt-8 mb-10 text-center text-xl font-acmeRegular font-semibold text-slate-700">Daftar Guru Dan Mapel</h1>
        {{-- akhir header --}}
            ...
            <table class="min-w-full bg-white border border-gray-200 rounded-lg ">
                <thead>
                    <tr class=" text-gray-700 border border-gray-300 uppercase text-sm leading-normal">
                        ...
                        <th class="py-3 px-6 text-center border border-gray-300">Mata Pelajaran Diampu</th>
                ...
                <tbody class="text-gray-900 text-sm ">
                    @foreach ($guruMapel as $gm)
                        <tr class="">
                            ...
                            <td class="border border-gray-300 py-3 px-6 text-center whitespace-nowrap"> {{ $gm->guru->NIP }} </td>
                            <td class="border border-gray-300 py-3 px-6 text-center whitespace-nowrap"> {{ $gm->guru->name  }}</td>
                            <td class="border border-gray-300 py-4 px-6 text-center whitespace-nowrap"> {{ $gm->mapel->name_mapel  ?? ' - ' }}</td>
                            <td class="border border-gray-300 py-4 px-6 text-center whitespace-nowrap">
                                <a href="/admin/guruMapel/{{ $gm->id }}/edit" class="underline">Edit</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
