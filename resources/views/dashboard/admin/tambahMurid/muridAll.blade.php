<div class="grid grid-cols-12 gap-6 mt-14">
    <div class="col-span-12 sm:col-span-12 bg-gray-50 shadowMe px-4 border-t-2 border-t-blue-500 pb-10 h-max">
        ...
        {{-- header --}}
        <h1 class="mt-8 mb-10 text-center text-xl font-acmeRegular font-semibold text-slate-700">Daftar Murid</h1>
        {{-- akhir header --}}
                    ...
                    @foreach ($murid as $m)
                        <tr class="">
                            ...
                            <td class="border border-gray-300 py-4 px-6 text-center whitespace-nowrap">
                                <a href="/admin/murid/{{ $m->id }}/edit" class="underline">Edit</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
